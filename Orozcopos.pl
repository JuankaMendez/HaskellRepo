...
/* signosenmeses(Mes,Signo):-horoscopo(Signo,D1,M1,D2,M2),(Mes=M1;Mes=M2). */
...
varios(D1,M1,D2,M2):-(M1=<(M2+1)),(NewM is (M1+1)),signo(D1,M1,Signo),write(Signo),nl,varios(D1,NewM,D2,M2).
